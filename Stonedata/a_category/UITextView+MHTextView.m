...
- (void)setPlaceHolderLabel:(NSString *)placeholder {
    ...
    self.placeholderLabel.frame = CGRectMake(7, 7, rect.size.width, 20);
...
- (void)setWordcountLable:(NSNumber *)limitLength {
     ...
     *  字数限制
     */
    self.wordCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame) - 0, CGRectGetWidth(self.frame) - 7, 20)];
...
- (void)layoutSubviews {
    ...
    if (self.limitLength && self.wordCountLabel) {
         ...
         */
        self.wordCountLabel.frame = CGRectMake(CGRectGetWidth(self.frame) - 70, 5,70 ,  kRealValue(24));
    }
    if (self.placeholder && self.placeholderLabel) {
        ...
        self.placeholderLabel.frame = CGRectMake(7, 5, 120, kRealValue(24));
    }
