...
@interface testViewController ()<MQTTSessionManagerDelegate>
/*
...
-(void)createview
{
    ...
    MHMessageManager *mag = [[MHMessageManager alloc]initWithTopic:@""];
    mag.getmsg = ^(NSString * _Nonnull Msgdata, NSString * _Nonnull topic) {
        MHLog(@"%@%@",Msgdata,topic);
