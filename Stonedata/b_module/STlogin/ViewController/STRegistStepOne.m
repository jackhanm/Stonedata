...
@implementation STRegistStepOne
...
-(void)createview
{
    ...
    [moreBtn setTitle:@"用户登录" forState:UIControlStateNormal];
    ...
    [_loginBtn addTarget:self action:@selector(getcode) forControlEvents:UIControlEventTouchUpInside];
...
- (void)getcode{
    ...
    STRegistStepTwo *vc = [[STRegistStepTwo alloc]init];
    [self.navigationController pushViewController:vc animated:YES];
