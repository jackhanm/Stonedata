//
//  MHPriceMoreOderOneViewController.m
//  mohu
//
...
@interface MHPriceMoreOderOneViewController ()<UITableViewDataSource,UITableViewDelegate, CYLTableViewPlaceHolderDelegate,MHNetworkErrorPlaceHolderDelegate>
...
@implementation MHPriceMoreOderOneViewController
...
-(void)getdata
{
    ...
    [[MHUserService sharedInstance]initwithStartPrizewithdrawAllType:@"0" pageSize:@"10" pageIndex:[NSString stringWithFormat:@"%ld",_index] morecompletionBlock:^(NSDictionary *response, NSError *error) {
    ...
    cell.PriceMoregotodetal = ^{
        if (self.listArr.count > 0) {
            ...
            if ([[NSString stringWithFormat:@"%@",singer.status] isEqualToString:@"3"]) {
                ...
                MHGuessMyPrizeViewController *vc= [[MHGuessMyPrizeViewController alloc]initWithwinningId:[NSString stringWithFormat:@"%@",singer.winningId] comefrom:@"prizemore"];
                [self.navigationController pushViewController:vc animated:YES];
            }
            if ([[NSString stringWithFormat:@"%@",singer.status] isEqualToString:@"4"]) {
                if ([[NSString stringWithFormat:@"%@",singer.expressStatus] isEqualToString:@"0"]) {
                    MHGuessOrderdetailViewController *vc = [[MHGuessOrderdetailViewController alloc]initWithwinningId:[NSString stringWithFormat:@"%@",singer.winningId] comefrom:@"prizemore" statu:@"10"] ;
                    [self.navigationController pushViewController:vc animated:YES];
                }
                if ([[NSString stringWithFormat:@"%@",singer.expressStatus] isEqualToString:@"1"]) {
                    MHGuessOrderdetailViewController *vc = [[MHGuessOrderdetailViewController alloc]initWithwinningId:[NSString stringWithFormat:@"%@",singer.winningId] comefrom:@"prizemore" statu:@"4"] ;
            ...
            if ([[NSString stringWithFormat:@"%@",singer.status] isEqualToString:@"5"]) {
                ...
                MHGuessOrderdetailViewController *vc = [[MHGuessOrderdetailViewController alloc]initWithwinningId:[NSString stringWithFormat:@"%@",singer.winningId] comefrom:@"prizemore" statu:@"5"] ;
                [self.navigationController pushViewController:vc animated:YES];
            }
            if ([[NSString stringWithFormat:@"%@",singer.status] isEqualToString:@"6"]) {
                MHGuessOrderdetailViewController *vc = [[MHGuessOrderdetailViewController alloc]initWithwinningId:[NSString stringWithFormat:@"%@",singer.winningId] comefrom:@"prizemore" statu:@"6"] ;
                [self.navigationController pushViewController:vc animated:YES];
            }
            if ([[NSString stringWithFormat:@"%@",singer.status] isEqualToString:@"7"]) {
//                MHGuessOrderdetailViewController *vc = [[MHGuessOrderdetailViewController alloc]initWithwinningId:[NSString stringWithFormat:@"%@",singer.winningId] comefrom:@"prizemore" statu:@"7"] ;
//                [self.navigationController pushViewController:vc animated:YES];
            }
