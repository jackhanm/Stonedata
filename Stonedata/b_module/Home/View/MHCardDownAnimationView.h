...
@interface MHCardDownAnimationView : UIView
{
    @protected
    UIView *contentView;
    @private
...
@optional
- (void)cardDownAnimationViewDidShow:(MHCardDownAnimationView *)cardDownView;
- (void)cardDownAnimationViewDidHide:(MHCardDownAnimationView *)cardDownView;

- (void)cardDownAnimationViewWillShow:(MHCardDownAnimationView *)cardDownView;
- (void)cardDownAnimationViewWillHide:(MHCardDownAnimationView *)cardDownView;
