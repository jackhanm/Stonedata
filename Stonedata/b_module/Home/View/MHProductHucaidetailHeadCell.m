//
//  MHProductHucaidetailHeadCell.m
//  mohu
//
...
@interface MHProductHucaidetailHeadCell()<TYCyclePagerViewDataSource, TYCyclePagerViewDelegate>

@end

@implementation MHProductHucaidetailHeadCell
...
-(void)createviewDic:(NSMutableDictionary *)dic
{
    ...
    prizePersonPricelabel.text =@"中猜价格¥201元";
    ...
    UILabel *hucailabel = [[UILabel alloc]initWithFrame:CGRectMake(kRealValue(16), kRealValue(10), kRealValue(60), kRealValue(20))];
    hucailabel.text =@"狐猜流程";
