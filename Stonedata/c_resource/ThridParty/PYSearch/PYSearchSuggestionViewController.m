...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        ...
        cell.textLabel.font = [UIFont fontWithName:kPingFangRegular size:kFontValue(13)];
...
//    cell.imageView.image = [NSBundle py_imageNamed:@"search"];
    cell.textLabel.text = [NSString stringWithFormat:@"  %@", self.searchSuggestions[indexPath.row]];
    return cell;
}
