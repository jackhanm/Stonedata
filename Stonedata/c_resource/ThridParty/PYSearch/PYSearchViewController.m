...
- (void)viewDidLayoutSubviews
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 11.0) { // iOS 11
        ...
        _searchBar.py_width = self.view.py_width  - PYSEARCH_MARGIN * 4 - adaptWidth;
...
//        [emptyButton setTitle:[NSBundle py_localizedStringForKey:PYSearchEmptyButtonText] forState:UIControlStateNormal];
        [emptyButton setImage:[UIImage imageNamed:@"search_empty"] forState:UIControlStateNormal];
...
//        UIView *lineView1 = [[UIView alloc]initWithFrame:CGRectMake(0, self.hotSearchView.py_x + 5, kScreenWidth, 5)];
//        lineView1.backgroundColor = [UIColor redColor];
//        [searchHistoryView addSubview:lineView1];
...
- (void)setup
{
    ...
    UISearchBar *searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0,0, kRealValue(295), 30)];
...
//    searchBar.layer.borderColor = [[UIColor colorWithHexString:@"cccccc"]CGColor];
    ...
    for (UIView *subView in [[searchBar.subviews lastObject] subviews]) {
        if ([[subView class] isSubclassOfClass:[UITextField class]]) {
            ...
            textField.backgroundColor = [UIColor colorWithHexString:@"#F2F3F5"];
            textField.font = [UIFont fontWithName:kPingFangRegular size:kFontValue(12)];
            UIImageView *view = [[UIImageView alloc] initWithImage:[UIImage  imageNamed:@"search_left_icon"]];
...
- (void)setupHotSearchRectangleTags
{
    ...
    self.baseSearchTableView.backgroundColor = [UIColor py_colorWithHexString:@"#ffffff"];
...
- (void)setSearchHistoryStyle:(PYSearchHistoryStyle)searchHistoryStyle
{
    ...
    switch (searchHistoryStyle) {
        ...
        case PYSearchHistoryStyleBorderTag:
            for (UILabel *tag in self.searchHistoryTags) {
                tag.backgroundColor = [UIColor colorWithHexString:@"F2F3F5"];
...
{
    return self.searchHistories.count && self.showSearchHistory && PYSearchHistoryStyleCell == self.searchHistoryStyle ? 5 : 0.01;
