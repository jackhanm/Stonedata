...
static NSInteger const lz_pickerHeight = 346;
static NSInteger const lz_buttonHeight = 30;

@interface JKCityPickView ()<UIPickerViewDelegate,UIPickerViewDataSource> {
...
- (void)layoutSubviews {
    ...
    self.commitButton.frame = CGRectMake(lz_screenWidth - 50, 15, 40, lz_buttonHeight - 10);
