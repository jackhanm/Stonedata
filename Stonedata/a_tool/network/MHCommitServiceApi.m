...
-(NSURLRequest *)buildCustomUrlRequest{
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@?appId=a2&appVer=%@&deviceId=%@&ts=%@&key=%@",kMHHost,kServiceList,[CTUUID getAppVersion],[CTUUID getIDFA],timeStap,[[NSString stringWithFormat:@"5IHqGdRBc0WxDZ%@%@",[CTUUID getIDFA],timeStap] do16MD5]]]];
